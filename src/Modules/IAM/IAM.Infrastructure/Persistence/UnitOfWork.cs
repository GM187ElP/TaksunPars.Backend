...
public class UnitOfWork : IAMDbContext, IDisposable
{
    private readonly IAMDbContext _dbContext;
    private IDbContextTransaction? _currentTransaction;

    public UnitOfWork(IAMDbContext dbContext) => _dbContext = dbContext ?? throw new ArgumentNullException(nameof(dbContext));
